...
const WISH_MESSAGES = [
	...
	"Phát tài phát lộc, tiền vào như nước 💰",
	"Chúc Chị một năm mới hạnh phúc",
	"Chúc Chị luôn xinh đẹp và rạng rỡ 🌸",
	"Chúc Chị 1 năm mới bình an",
	"Chúc mọi điều ước của Chị đều trở thành hiện thực ✨",
	"Chúc gia đình Chị luôn bình an và hạnh phúc ❤️",
	"Chúc Chị luôn khỏe mạnh và tràn đầy năng lượng 💪",
	"Chúc Chị mọi công việc thuận lợi, thăng tiến không ngừng 🚀",
	"Chúc Chị luôn mỉm cười và yêu đời mỗi ngày 😊",
	"Chúc Chị gặp nhiều may mắn và niềm vui 🎉",
	"Chúc Chị sẽ gặp được người mà  luôn yêu thương, chăm sóc Chị thật tốt 💖",
	"Chúc Chị có một năm mới tràn đầy hạnh phúc và thành công 🌟",
	"Chúc Chị luôn giữ được sự lạc quan và nhiệt huyết trong cuộc sống 🌈",
	"Chúc Chị có những chuyến du lịch tuyệt vời và trải nghiệm đáng nhớ ✈️",
	"Chúc Chị luôn được bao quanh bởi những người thân yêu và bạn bè tốt 🤗",
	"Chúc Chị có một năm mới đầy ắp tiếng cười và niềm vui 😄",				
];
